...
@objc public protocol WebServiceManagerDelegate: NSObjectProtocol {
    func webService(_ manager: WebServiceManager, didErr error: Error, type: WebServiceType)
    @objc optional func webService(_ manager: WebServiceManager, didFetch data: Any, type: WebServiceType)
    @objc optional func webService(_ manager: WebServiceManager, didPost data: Any, type: WebServiceType)
    @objc optional func webService(_ manager: WebServiceManager, didPatch data: Any, type: WebServiceType)
    @objc optional func webService(_ manager: WebServiceManager, didDelete data: Any, type: WebServiceType)
}
 ...
 */
@objc public enum WebServiceType: Int {
    case tests
}
